...
#### Hero
- 풀스크린 다크 그라데이션 배경
- **회사 풀네임 "닥터스 브랜드 매니저"를 최상단 가장 크게** 배치
- eyebrow 라인: `닥브매 | Doctor's Brand Manager`
- 서브 태그라인 + 그라데이션 텍스트 강조
- 배경 블롭 애니메이션 (블루 + 틸)
...
| 그로스 플랜 (STANDARD) | 블로그 + 플레이스 + 카페 | 3채널, 추천 배지 |
...
- [ ] Portfolio 페이지 제작
- [ ] Blog 페이지 제작
- [ ] SEO 메타태그 최적화 (title, description, og 태그)
